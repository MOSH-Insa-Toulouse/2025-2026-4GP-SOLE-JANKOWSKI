...
-  Activ low-pass filter with cutoff frequency of 1.6 Hz that filters the frequency generated by the power         grid (50 Hz).
-  Input : Passive low-pass filter with cutoff frequency of 16 Hz that filters out the current 
    noise from the input.
-  Output : Passive low-pass filter with cutoff frequency of 1.6 kHz that filters out the noise from within        the circuit.
...
![Figure 4](./Images/pcb_electrical_diagram.png)
...
![Figure 5](./Images/footprint_pcb.png)
